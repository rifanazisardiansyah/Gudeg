	  ...
	  <div class="container-fluid">
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand" href="<?php echo base_url('/home.html') ?>">
	      	 <img width="100" alt="Brand" src="http://localhost/gudegparto/asset/img/logohome.svg">
	      </a>
	    </div>
	    <div class="collapse navbar-collapse" id="myNavbar">
	      <ul class="nav navbar-nav navbar-right">
	      	<li class="active"><a id="nav-menu" href="<?php echo base_url('/lihat-menu.html')?>">Menu</a></li>
