...
<body onload="window.print()" style="margin-bottom:50px">
	<div class="container bordered">
		<h3>
			<img class="img-responsive" alt="Brand" src="asset/img/simbah.PNG"><br> Tagihan Pemesanan
		</h3><br>
		...
		<div class="table-responsive">
			<table class="table">
				...
				<tr>
					...
					<td>:</td>
					<td><?php echo $metode==0?"Ambil Sendiri":"Jasa Antar"?></td>
				</tr>
			</table>	
		</div>
		...
		<div>
			...
			<div style="padding-top:20px;margin-bottom:20px" class="col-sm-12  text-center bg-info">
				<ul class="list-unstyled">
					<li><label>Bank BNI 	: 1298-0986-88 AN: Muhammad Khansa Adiyansyah </label></li>
					<li><label>Bank Mandiri : 137-002-362-5417    AN: Muhammad Khansa Adiyansyah </label></li>
				</ul>
			</div>
			<p>
